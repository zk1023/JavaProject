...
public class ShapeletExamples2 {
		...
		for (int a = 0; a < 12; a++) {
			...
			for (int n = 0; n < 2; n++) {
				...
				for (int i = 0; i < folds; i++) {
					train = randData.trainCV(folds, 2);
					test = randData.testCV(folds, 2);
			...
			System.out.println("random forest average accuracy = " + (sum_randomforest / 6));
			System.out.println("涓嬩竴涓�------------------------------------------------------");
			writeShapelet(max_clusteredShapelets, a);
		}
