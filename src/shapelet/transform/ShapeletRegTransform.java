...
public class ShapeletRegTransform extends ShapeletTransform{
    ...
    *//**
     ...
     *//*
    public ShapeletRegTransform(int k){
    ...
    *//**
     ...
     *//*
    public ShapeletRegTransform(int k, int minShapeletLength, int maxShapeletLength){
    ...
    *//**
     ...
     *//*
    public ShapeletRegTransform(int k, int minShapeletLength, int maxShapeletLength, weka.core.shapelet.QualityMeasures.ShapeletQualityChoice qualityChoice){
...
//                        
                    ...
                    QualityBound.ShapeletQualityBound qualityBound = null;
...
//                }
    ...
    *//**
     ...
     * @return a TreeMap<Double, Double> in the form of <Class Value, Distance>
     *//*
    ...
    *//**
     ...
     *//*
    protected Shapelet checkCandidate(double[] candidate, Instances data, int seriesId, int startPos, ArrayList classDistances, QualityBound.ShapeletQualityBound qualityBound){
...
//        }
    ...
    protected double[] zNorm(double[] input, boolean classValOn){        
        return ShapeletRegTransform.zNormalise(input, classValOn);
    }
    ...
    *//**
     ...
     * @throws Exception
     *//*
    public static ShapeletRegTransform createFilterFromFile(String fileName) throws Exception{
    ...
    *//**
     ...
     * @throws Exception
     *//*
    public static ShapeletRegTransform createFilterFromFile(String fileName, int maxShapelets) throws Exception{

        File input = new File(fileName);
        Scanner scan = new Scanner(input);
        scan.useDelimiter("\n");

        ShapeletRegTransform sf = new ShapeletRegTransform();
   ...
   public static void main(String[] args){
       ...
       //     Instances data= ShapeletRegTransform.loadData(args[0]);

            ShapeletRegTransform sf = new ShapeletRegTransform(k, minLength, maxLength);
